...
# 파일불러오기
draw_korea_ra = pd.read_excel('./static/data/draw_korea_raw(수정).xlsx', encoding='EUC-KR')
...
def drawKorea(targetData, blockedMap, cmapname, filename): # blockedMap 맵 # targetData: 칼럼명 cmapname: 컬러코드
    gamma = 0.75
    ...
    # 지역 이름 표시
    for idx, row in blockedMap.iterrows(): # idx대신 _을쓰면 blockedMap을 나누되 _은 쓰지 않겠다라는 뜻
